...
class UserForm(UserCreationForm):
    class Meta:
        ...
        widgets = {
            ...
            'date_of_birth': TextInput(attrs={'placeholder': 'Please enter your date of birth', 'class': 'form-control', 'type': 'date'}),
            'county': TextInput(attrs={'placeholder': 'Please enter your county', 'class': 'form-control'}),
